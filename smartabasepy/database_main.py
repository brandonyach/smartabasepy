...
def get_database(
    ...
    Examples:
        >>> from smartabasepy import get_database
        >>> df = get_database(
        ...     form_name = "Allergies",
...
def delete_database_entry(
    ...
    Examples:
        >>> from smartabasepy import delete_database_entry
...
def insert_database_entry(
    ...
    Examples:
        >>> import pandas as pd
        >>> from smartabasepy import insert_database_entry
        >>> from smartabasepy import InsertDatabaseOption
        >>> df = pd.DataFrame({
...
def update_database_entry(
    ...
    Examples:
        >>> import pandas as pd
        >>> from smartabasepy import update_database_entry
        >>> from smartabasepy import UpdateDatabaseOption
        >>> df = pd.DataFrame({
