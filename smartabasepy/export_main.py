...
def get_event_data(
    ...
    Examples:
        >>> import pandas as pd
        >>> from smartabasepy import get_event_data
        >>> from smartabasepy import EventFilter
...
def sync_event_data(
    ...
    Examples:
        >>> from smartabasepy import sync_event_data
        >>> from smartabasepy import SyncEventFilter
...
def get_profile_data(
    ...
    Examples:
        >>> import pandas as pd
        >>> from smartabasepy import get_profile_data
        >>> from smartabasepy import ProfileFilter
