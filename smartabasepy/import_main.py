...
def insert_event_data(
    ...
    Examples:
        >>> import pandas as pd
        >>> from smartabasepy import insert_event_data
...
def update_event_data(
    ...
    Examples:
        >>> import pandas as pd
        >>> from smartabasepy import update_event_data
...
def upsert_event_data(
    ...
    Examples:
        >>> import pandas as pd
        >>> from smartabasepy import upsert_event_data
...
def upsert_profile_data(
    ...
    Examples:
        >>> import pandas as pd
        >>> from smartabasepy import upsert_profile_data
